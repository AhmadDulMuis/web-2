                                    ...
                                    <div class="row align-items-center gx-5">
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                ...
                                                <div class="mb-2">
                                                    <div class="small fw-bolder">MI AL-AMANAH KIARASARI</div>
                                                    <div class="small fw-bolder">MTS AL-FATHA KIARASARI</div>
                                                </div>
                                                <div class="fst-italic">
                                                    <div class="small fw-bolder">SMK INSAN MADANI SUKAJAYA</div>
                                                </div>
                                            </div>
                                        </div>
